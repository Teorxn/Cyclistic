...
1. Eliminación de registros con duraciones de viaje negativas o nulas.
2. Exclusión de viajes de prueba internos del sistema.
3. Creación de nuevas columnas: Duración del viaje (en minutos) y Día de la semana.
